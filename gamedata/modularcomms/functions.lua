...
function DynamicApplyWeapon(unitDef, weapon, slot)
	...
	unitDef.sfxtypes.explosiongenerators[7 + slot*2] = wcp.muzzleeffectshot and ("custom:" .. wcp.muzzleeffectshot) or "custom:NONE"
end
...
function ApplyWeapon(unitDef, weapon, replace, forceslot)
	...
	if mapWeaponToCEG[slot] and unitDef.sfxtypes and unitDef.sfxtypes.explosiongenerators then
		...
		unitDef.sfxtypes.explosiongenerators[mapWeaponToCEG[slot][2]] = wcp.muzzleeffectshot and ("custom:" .. wcp.muzzleeffectshot) or "custom:NONE"
	end
